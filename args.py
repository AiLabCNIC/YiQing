...
# swa
parser.add_argument('--swa', type=bool, default=True, help='swa usage flag (default: off)')
parser.add_argument('--swa_start', type=float, default=500, metavar='N', help='SWA start epoch number (default: 161)')
parser.add_argument('--swa_lr', type=float, default=5e-5, metavar='LR', help='SWA LR (default: 0.05)')
